...
#########################################################################
# Ansible playbook to install docker network
#########################################################################
async def install_docker_network():
    logger.info(f"Install Docker Network")
    ...
    def run_ansible():
        ...
        thread, runner = ansible_runner.run_async(
            private_data_dir=constants.basedir+"/dockernetwork/playbooks", 
            inventory={'all': hosts},
